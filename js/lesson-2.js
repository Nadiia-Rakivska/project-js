...
// console.log(styles);
// const index = styles.indexOf('blwues');
// if (index!==-1) {
...
//   const login = prompt("ВВедіть ім’я користувача: ")
...
//   return total / count;
// }
// console.log(caclculateAverage(5,7,"88"));
...
// const sumeArr = [22, 11, 34, 5, 12, 13, 14, 15];
// function sumNum(arr) {
//   const newArr = [];
...
// if (arguments.length<2&&numbers.length) {
...
const calculator = {
  ...
  exist() {   
    return Boolean(this.a) && Boolean(this.b);
     }
}
